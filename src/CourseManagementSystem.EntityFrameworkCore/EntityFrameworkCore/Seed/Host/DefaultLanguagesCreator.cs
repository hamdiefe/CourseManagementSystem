...
namespace CourseManagementSystem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CourseManagementSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(CourseManagementSystemDbContext context)
        {
            _context = context;
        }
