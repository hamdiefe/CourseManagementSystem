...
using CourseManagementSystem.Web.Models.Account;
using CourseManagementSystem.Web.Views.Shared.Components.TenantChange;

namespace CourseManagementSystem.Web.Controllers
{
    public class AccountController : CourseManagementSystemControllerBase
    {
