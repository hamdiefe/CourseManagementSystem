...
{
    public abstract class CourseManagementSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CourseManagementSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CourseManagementSystemWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<CourseManagementSystemDbContext> action)
        {
            using (var context = IocManager.Resolve<CourseManagementSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<CourseManagementSystemDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<CourseManagementSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CourseManagementSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CourseManagementSystemDbContext, Task<T>> func)
        {
            T result;
